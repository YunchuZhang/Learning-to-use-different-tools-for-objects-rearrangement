...
from ravens.agents.transporter import ToolTransporterAgent
from ravens.agents.transporter import BCTransporterAgent
# from ravens.agents.transporter import SETransporterAgent
...
names = {'dummy': DummyAgent,
		 'tooltransporter' : ToolTransporterAgent,
		 'bctransporter' : BCTransporterAgent,
		 # 'selecttransporter' : SETransporterAgent,
